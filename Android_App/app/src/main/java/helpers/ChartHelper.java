...
public class ChartHelper implements OnChartValueSelectedListener {
    ...
    public ChartHelper(LineChart chart) {
        ...
        mChart.setBorderColor(Color.rgb(67,64,134));
        ...
        l.setTextColor(Color.rgb(67, 64, 134));

        XAxis xl = mChart.getXAxis();
        xl.setTypeface(Typeface.MONOSPACE);
        xl.setTextColor(Color.rgb(67, 64, 134));
        ...
        leftAxis.setTextColor(Color.rgb(67, 64, 134));
    ...
    private LineDataSet createSet() {
        ...
        set.setColor(Color.rgb(67, 64, 134));
        //set.setCircleColor(Color.WHITE);
        set.setLineWidth(2f);
        //set.setCircleRadius(4f);
        set.setFillAlpha(65);
        set.setFillColor(Color.rgb(67, 64, 134));
        set.setHighLightColor(Color.rgb(67, 64, 134));
        set.setValueTextColor(Color.rgb(67, 64, 134));
